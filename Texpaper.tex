...
\title[BLAEs -- I.]{BLAEs -- I. Super-resolving normal Lyman alpha emitting galaxies between redshift 2 to 3 with gravitational lensing}
...
The BLAEs sample was observed with the {\it Hubble Space Telescope} ({\it HST}) using the WFC3 camera and the F606W filter between 2015 November and 2016 May (GO: 14189; PI: Bolton). In total, twenty one candidate gravitationally lensed Lyman-alpha emitting galaxies from the \citet{Shu16} sample were observed for about 2500~s each. As their redshifts span from $z \sim 2$ to 3, these observations probed the rest-frame ultraviolet emission between 1500 and 2000~\AA.
